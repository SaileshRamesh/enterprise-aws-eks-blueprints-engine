output "vpc_id" {
  description = "VPC ID created for the production environment"
  value       = module.vpc.vpc_id
}

output "vpc_cidr" {
  description = "VPC CIDR block for the production environment"
  value       = module.vpc.vpc_cidr
}

output "public_subnet_ids" {
  description = "Public subnet IDs for the production VPC"
  value       = module.vpc.public_subnet_ids
}

output "private_subnet_ids" {
  description = "Private subnet IDs for the production VPC"
  value       = module.vpc.private_subnet_ids
}

output "eks_cluster_id" {
  description = "EKS cluster ID for the production environment"
  value       = module.eks.eks_cluster_id
}

output "eks_cluster_endpoint" {
  description = "EKS cluster endpoint for the production environment"
